...
#include <stdio.h>
#endif
#define debug(msg) fprintf(stderr, "[ROM]: "#msg"\n")
#define debugarg(msg, arg) fprintf(stderr, "[ROM]: "#msg"\n", arg)
#else
#define debug(msg)
...
#ifndef NDEBUG
#define debugonly(var) var
#else
#define debugonly(var) UNUSED__##var __attribute__((unused))
#endif
#else
